...
import { LoginEmailValidation, LoginPasswordValidation, signInFormValues } from '../types/signInValidationInterface';
            ...
            <form onSubmit={handleSubmit(onSubmit)}>
                ...
                <div>
                    <div className="my-2 block pl-1">
                        <label
                            htmlFor="password1"
                            className={!errors.password ? 'border-gray-300 text-sm' : 'text-red-600 text-sm'}
                        >
                            Password
                        </label>
                    </div>
                    ...
                    />
                    <p className={!errors ? '' : 'text-red-600 text-sm mt-2 pl-1'}>{errors.password?.message}</p>
                </div>
